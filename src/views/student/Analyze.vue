<template>
    <div class="analyze">
        ...
        <div class="analyze-header">
            ...
            <div class="info">
                ...
                <div style="display: flex;gap: 40px;">
                    ...
                    <div class="flex-column">
                        <span style="color:#f56c6c;">0</span>
        ...
        <div class="analyze-discuss">
            <div style="font-size: 20px;">讨论</div>
            <div class="list">
                <div>
                    <span>10</span>
                    <div class="font12-999">课堂发布数</div>
                </div>
                <div class="divide"></div>
                <div>
                    <span>9</span>
                    <div class="font12-999">参与数</div>
                </div>
                <div class="divide"></div>
                <div>
                    <span>2</span>
                    <div class="font12-999">被回复</div>
                </div>
            </div>
        </div>
        ...
        <div class="analyze-resource">
            <div style="font-size: 20px;">资源</div>
        </div>
    </div>
</template>
...
/**
 * 成绩计算规则：
 *         视频资源：在计分时间内观看视频，可以记录观看进度，根据视频观看进度计分，每个视频所占的分值相同，根据观看进度得分
 *         作业：所有作业的平均得分
 *         考勤：出勤得分，缺勤不得分，请假和迟到得一半分数
 *         评论：每个同学应该进行至少四次评论
 *         答辩：答辩得分，未参加答辩得0分
 *         总成绩：所有成绩的加权平均数，占权比例：视频资源20%，作业30%，考勤20%，评论10%，答辩20%
 */
