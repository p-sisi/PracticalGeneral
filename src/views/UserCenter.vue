<template>
    <div class="center">
        <div class="image">
            <div class="img">
                <img :src="`${BASE_ERL}/file/images/${commonStore.userInfo.headImg}`" alt="">
            </div>
        ...
        <div class="info">
            ...
            <div class="info-basic">
                <div>
                    <span>姓名：</span>
                    <span v-if="!isEditName">{{ commonStore.userInfo.name }}</span>
                ...
                <div>
                    <span>职业：</span>
                    <span>{{ commonStore.userInfo.userType == 2 ? '学生':'教师' }}</span>
                </div>
            </div>
            <!-- 安全设置 -->
...
import { fetchUpdateUserName, fetchSendEmailCode, fetchUpdateUserPasswordByEmail,fetchUpdateUserPasswordByOld, fetchBindEmail, fetchLoginIn, fetchHasBindEmail } from '../apis/modules/user'
...
const handleClickEditName = () => {
    ...
    editName.value = commonStore.userInfo.name;
}
